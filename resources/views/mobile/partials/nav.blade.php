<div class="nav-button hidden navbar-item">
    Menu
    <div class="navbar flex justify-around text-center p-5 font-bold my-2 w-full">
        ...
        <div class="navbar-item">
            ...
            <div class="navbar-dropdown flex flex-col items-start">
                ...
                <div class="navbar-dropdown-item w-full">
                    <a href="{{route('essay.index')}}">Essays &amp; Talks</a>
                </div>
            </div>
        </div>
        <div class="navbar-item">
        ...
        <div class="navbar-item">
            <a href="{{route('article.show', 'services')}}">Services</a>
        </div>
    
        <div class="navbar-item">
            <a href="{{route('article.show', 'links')}}">Links</a>
        </div>
    </div>
</div>
